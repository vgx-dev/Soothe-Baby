...
export function AppIcon({ size = 120, animated = false }: AppIconProps) {
  ...
  return (
    <motion.div
      {...iconMotion}
      className="inline-flex items-center justify-center rounded-[28%] shadow-2xl relative overflow-hidden"
      style={{
        width: size,
        height: size,
        background: "linear-gradient(135deg, #1A73E8 0%, #7B2CBF 50%, #FF006E 100%)",
      }}
    >
      {/* Subtle glow overlay */}
      <div
